...
#include <yolov8_segmentation_tracking_ros/YoloResult.h>
...
typedef message_filters::sync_policies::ApproximateTime<sensor_msgs::CameraInfo, sensor_msgs::PointCloud2,
                                                        yolov8_segmentation_tracking_ros::YoloResult>
...
private:
  ...
  message_filters::Subscriber<yolov8_segmentation_tracking_ros::YoloResult> yolo_result_sub_;
...
public:
  ...
  void syncCallback(const sensor_msgs::CameraInfo::ConstPtr& camera_info_msg,
                    ...
                    const yolov8_segmentation_tracking_ros::YoloResult::ConstPtr& yolo_result_msg);
  void projectCloud(const pcl::PointCloud<pcl::PointXYZ>::Ptr& cloud,
                    const yolov8_segmentation_tracking_ros::YoloResultConstPtr& yolo_result_msg, const std_msgs::Header& header,
